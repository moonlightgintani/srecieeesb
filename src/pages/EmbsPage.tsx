          ...
          >
            <div className="md:col-span-2 border border-slate-200 bg-white p-8 md:p-12">
              ...
              <p className="text-slate-600 leading-relaxed mb-6 font-medium">
                The IEEE Engineering in Medicine and Biology Society (EMBS) organizes high-impact technical symposiums, hands-on industrial workshops, and expert lectures focusing on the bleeding edge of modern engineering.
              </p>
